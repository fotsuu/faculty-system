...
@section('title', 'View Class Record - Dean Dashboard')
...
@section('content')
    <div class="section">
        <div class="section-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid #edf2f7;">
            <div>
                <a href="{{ route('dean.class-records') }}" style="display: inline-flex; align-items: center; color: #1e3c72; text-decoration: none; font-size: 14px; font-weight: 600; margin-bottom: 12px;">
